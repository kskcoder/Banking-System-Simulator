...
public class TransactionController {
	...
	public ResponseEntity<List<Transaction>> getDebitTransaction(@PathVariable String accountNumber) {
		return accountService.getDebitTransaction(accountNumber);
	}
	
	@GetMapping("/credit/{accountNumber}")
	public ResponseEntity<List<Transaction>> getCreditTransaction(@PathVariable String accountNumber) {
